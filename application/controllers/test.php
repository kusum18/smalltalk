...
class Test extends REST_Controller {
	...
	function testing_get($user_id, $start, $totalrecords)
	{
		...
		//fetching data from userfriend table with user id as given in the get method $user_id
		$friedndObj->where('user_id',$user_id)->get();
